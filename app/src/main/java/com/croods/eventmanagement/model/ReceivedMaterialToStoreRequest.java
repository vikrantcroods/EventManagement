...
public class ReceivedMaterialToStoreRequest {
    ...
    public ReceivedMaterialToStoreRequest(int eventId, String driverMobileNo, String driverName, String employeeIds, String materialInwardDate, int storeId, String note, String transportId, String vehicleNo, List<Long> materialInwardItemVos) {
